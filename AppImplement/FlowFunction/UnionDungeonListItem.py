...
from AppImplement.FormFiles.UnionDungeonParam import Ui_UnionDungeonParam
...
class UnionDungeonListWidget(BaseListWidget):
    def __init__(self, func_name, parent=None):
        super().__init__(func_name, parent)

        self.func_widget = UnionDungeonParamWidget()

    def getFuncParam(self, get_for_json=False):
        return self.func_widget.getAllParam(get_for_json)


class UnionDungeonParamWidget(Ui_UnionDungeonParam, BaseParamWidget):
    def __init__(self):
        super(UnionDungeonParamWidget, self).__init__()
        self.setupUi(self)
    ...
    def getAllParam(self, get_for_json=False):
        return {
            ...
            "level_name": self.comboBox_level_name.currentText(),
    ...
    def setAllParam(self, param_dict):
        ...
        self.comboBox_level_name.setCurrentText(param_dict["level_name"])
