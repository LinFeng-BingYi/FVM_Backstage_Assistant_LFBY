...
from AppImplement.FormFiles.MagicTowerParam import Ui_MagicTowerParam
...
class MagicTowerListWidget(BaseListWidget):
...
class MagicTowerParamWidget(Ui_MagicTowerParam, BaseParamWidget):
    def __init__(self):
        super(MagicTowerParamWidget, self).__init__()
        self.setupUi(self)
    ...
    def getAllParam(self, get_for_json=False):
        return {
            ...
            "level_num": int(self.lineEdit_level_num.text()),
    ...
    def setAllParam(self, param_dict):
        ...
        self.lineEdit_level_num.setText(str(param_dict["level_num"]))
