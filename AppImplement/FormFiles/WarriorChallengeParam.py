...
################################################################################
## Form generated from reading UI file 'WarriorChallengeParam.ui'
##
...
class Ui_WarriorChallengeParam(object):
    def setupUi(self, WarriorChallengeParam):
        if not WarriorChallengeParam.objectName():
            WarriorChallengeParam.setObjectName(u"WarriorChallengeParam")
        WarriorChallengeParam.resize(530, 340)
        self.verticalLayout_top = QVBoxLayout(WarriorChallengeParam)
        ...
        self.groupBox_select_players = QGroupBox(WarriorChallengeParam)
        ...
        self.groupBox_select_level = QGroupBox(WarriorChallengeParam)
        ...
        self.horizontalLayout_select_level.setContentsMargins(-1, 0, -1, 5)
        self.label_boss_pic = QLabel(self.groupBox_select_level)
        self.label_boss_pic.setObjectName(u"label_boss_pic")
        self.label_boss_pic.setMaximumSize(QSize(67, 16777215))

        self.horizontalLayout_select_level.addWidget(self.label_boss_pic)

        self.lineEdit_boss_pic = QLineEdit(self.groupBox_select_level)
        self.lineEdit_boss_pic.setObjectName(u"lineEdit_boss_pic")
        self.lineEdit_boss_pic.setMinimumSize(QSize(0, 30))

        self.horizontalLayout_select_level.addWidget(self.lineEdit_boss_pic)

        self.pushButton_boss_pic = QPushButton(self.groupBox_select_level)
        self.pushButton_boss_pic.setObjectName(u"pushButton_boss_pic")
        self.pushButton_boss_pic.setMinimumSize(QSize(80, 30))
        self.pushButton_boss_pic.setMaximumSize(QSize(80, 30))

        self.horizontalLayout_select_level.addWidget(self.pushButton_boss_pic)


        self.verticalLayout_top.addWidget(self.groupBox_select_level)

        self.groupBox_select_plan = QGroupBox(WarriorChallengeParam)
        ...
        self.groupBox_level_setting = QGroupBox(WarriorChallengeParam)
        ...
        self.retranslateUi(WarriorChallengeParam)

        QMetaObject.connectSlotsByName(WarriorChallengeParam)
    # setupUi

    def retranslateUi(self, WarriorChallengeParam):
        WarriorChallengeParam.setWindowTitle(QCoreApplication.translate("WarriorChallengeParam", u"Form", None))
        self.groupBox_select_players.setTitle(QCoreApplication.translate("WarriorChallengeParam", u"\u9009\u62e9\u8d26\u53f7", None))
        self.label_select_1p.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u623f\u4e3b\uff1a", None))
        self.comboBox_select_1p.setItemText(0, QCoreApplication.translate("WarriorChallengeParam", u"1P", None))
        self.comboBox_select_1p.setItemText(1, QCoreApplication.translate("WarriorChallengeParam", u"2P", None))

        self.label_select_2p.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u623f\u5ba2\uff1a", None))
        self.comboBox_select_2p.setItemText(0, QCoreApplication.translate("WarriorChallengeParam", u"\u65e0", None))
        self.comboBox_select_2p.setItemText(1, QCoreApplication.translate("WarriorChallengeParam", u"1P", None))
        self.comboBox_select_2p.setItemText(2, QCoreApplication.translate("WarriorChallengeParam", u"2P", None))

        self.groupBox_select_level.setTitle(QCoreApplication.translate("WarriorChallengeParam", u"\u9009\u62e9\u5173\u5361", None))
        self.label_boss_pic.setText(QCoreApplication.translate("WarriorChallengeParam", u"BOSS\u622a\u56fe\uff1a", None))
#if QT_CONFIG(tooltip)
        self.lineEdit_boss_pic.setToolTip(QCoreApplication.translate("WarriorChallengeParam", u"\u622a\u53d6BOSS\u4f4d\u4e8e\u6b63\u4e2d\u592e\u65f6\u7684\u56fe\u50cf", None))
#endif // QT_CONFIG(tooltip)
        self.lineEdit_boss_pic.setPlaceholderText(QCoreApplication.translate("WarriorChallengeParam", u"\u622a\u53d6BOSS\u4f4d\u4e8e\u6b63\u4e2d\u592e\u65f6\u7684\u56fe\u50cf", None))
#if QT_CONFIG(tooltip)
        self.pushButton_boss_pic.setToolTip(QCoreApplication.translate("WarriorChallengeParam", u"\u622a\u53d6BOSS\u4f4d\u4e8e\u6b63\u4e2d\u592e\u65f6\u7684\u56fe\u50cf", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_boss_pic.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u6d4f\u89c8", None))
        self.groupBox_select_plan.setTitle(QCoreApplication.translate("WarriorChallengeParam", u"\u9009\u62e9\u65b9\u6848", None))
        self.label_plan_path.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u65b9\u6848\u8def\u5f84\uff1a", None))
        self.pushButton_plan_path.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u6d4f\u89c8", None))
        self.label_1p_plan.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u653e\u5361\u65b9\u6848\uff1a", None))
        self.pushButton_view_plan.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u67e5\u770b\u65b9\u6848", None))
        self.groupBox_level_setting.setTitle(QCoreApplication.translate("WarriorChallengeParam", u"\u901a\u5173\u8bbe\u7f6e", None))
        self.label_loop_count.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u5faa\u73af\u6b21\u6570\uff1a", None))
        self.lineEdit_loop_count.setText(QCoreApplication.translate("WarriorChallengeParam", u"5", None))
        self.label_flop_pos.setText(QCoreApplication.translate("WarriorChallengeParam", u"\u7ffb\u724c\u4f4d\u7f6e\uff1a", None))
        self.lineEdit_flop_pos.setText(QCoreApplication.translate("WarriorChallengeParam", u"1;2;3;4;5;6", None))
    # retranslateUi
