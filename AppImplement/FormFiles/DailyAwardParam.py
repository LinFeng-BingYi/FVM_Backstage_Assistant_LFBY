...
class Ui_DailyAwardParam(object):
    def setupUi(self, DailyAwardParam):
        ...
        self.gridLayout_cycle.setHorizontalSpacing(5)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_union_garden, 0, 5, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_give_flowers, 3, 0, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_union_quest, 1, 0, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.comboBox_use_coupon_times, 3, 8, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_force_destiny_tree, 2, 7, 1, 2)
        ...
        self.gridLayout_cycle.addWidget(self.line_cycle, 0, 4, 3, 1)
        ...
        self.gridLayout_cycle.addWidget(self.comboBox_pharaoh_flop_pos, 0, 2, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.label_plant_type, 0, 7, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_open_food_contest, 1, 5, 1, 2)

        self.checkBox_need_fertilize = QCheckBox(self.groupBox_cycle)
        self.checkBox_need_fertilize.setObjectName(u"checkBox_need_fertilize")
        self.checkBox_need_fertilize.setMinimumSize(QSize(45, 30))

        self.gridLayout_cycle.addWidget(self.checkBox_need_fertilize, 0, 6, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.label_use_coupon_times, 3, 7, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_destiny_tree, 2, 5, 1, 2)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_use_gift_coupon, 3, 5, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.label_flowers_receiver, 3, 1, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.pushButton_flowers_receiver, 3, 3, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.lineEdit_flowers_receiver, 3, 2, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.comboBox_garden_plant_type, 0, 8, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_team_magic_tower, 2, 0, 1, 2)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_release_quest, 1, 2, 1, 2)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_open_backpack, 1, 7, 1, 1)
        ...
        self.gridLayout_cycle.addWidget(self.checkBox_force_team_magic_tower, 2, 2, 1, 2)
        ...
        self.gridLayout_cycle.setColumnStretch(5, 4)
        self.gridLayout_cycle.setColumnStretch(6, 1)
        self.gridLayout_cycle.setColumnStretch(7, 2)
        self.gridLayout_cycle.setColumnStretch(8, 3)
    ...
    def retranslateUi(self, DailyAwardParam):
        ...
        self.checkBox_need_fertilize.setText(QCoreApplication.translate("DailyAwardParam", u"\u65bd\u80a5", None))
