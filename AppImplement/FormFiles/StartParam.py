...
class Ui_StartParam(object):
    def setupUi(self, StartParam):
        ...
        self.gridLayout_player_setting.addWidget(self.label_1p_2nd_psw, 2, 0, 1, 1)
        ...
        self.lineEdit_1p_2nd_psw.setMinimumSize(QSize(0, 30))
        self.lineEdit_1p_2nd_psw.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_player_setting.addWidget(self.lineEdit_1p_2nd_psw, 2, 1, 1, 2)

        self.label_2p_2nd_psw = QLabel(self.groupBox_player_setting)
        self.label_2p_2nd_psw.setObjectName(u"label_2p_2nd_psw")

        self.gridLayout_player_setting.addWidget(self.label_2p_2nd_psw, 2, 3, 1, 1)
        ...
        self.lineEdit_2p_2nd_psw.setMinimumSize(QSize(0, 30))
        self.lineEdit_2p_2nd_psw.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_player_setting.addWidget(self.lineEdit_2p_2nd_psw, 2, 4, 1, 2)
        ...
        self.horizontalLayout = QHBoxLayout(self.groupBox_necessity_pic)
        self.horizontalLayout.setSpacing(5)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(9, 0, -1, 5)
        ...
        self.horizontalLayout.addWidget(self.label_1p_name_pic)
        ...
        self.horizontalLayout.addWidget(self.lineEdit_1p_name_pic)
        ...
        self.horizontalLayout.addWidget(self.pushButton_1p_name_pic)
        ...
        self.horizontalLayout.addWidget(self.label_2p_name_pic)
        ...
        self.horizontalLayout.addWidget(self.lineEdit_2p_name_pic)
        ...
        self.horizontalLayout.addWidget(self.pushButton_2p_name_pic)
    ...
    def retranslateUi(self, StartParam):
        ...
        self.lineEdit_1p_2nd_psw.setPlaceholderText(QCoreApplication.translate("StartParam", u"\u4e3a\u7a7a\u65f6\u8868\u793a\u4e0d\u89e3\u9501", None))
        self.label_2p_2nd_psw.setText(QCoreApplication.translate("StartParam", u"\u4e8c\u7ea7\u5bc6\u7801\uff1a", None))
        self.lineEdit_2p_2nd_psw.setPlaceholderText(QCoreApplication.translate("StartParam", u"\u4e3a\u7a7a\u65f6\u8868\u793a\u4e0d\u89e3\u9501", None))
